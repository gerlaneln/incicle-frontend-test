...
import { Typography, ThemeProvider, createMuiTheme, Avatar, AppBar, Stack, Dialog, Tooltip, DialogTitle, List, ListItem, ListItemAvatar, Alert, AlertTitle, Button, Card, CardActions, CardActionArea, CardContent, CardMedia,  CssBaseline, FormControl, Grid, Select, MenuItem, Toolbar, Container} from '@material-ui/core';
                            ...
                            <Grid container spacing={3} justify="space-between" alignItems="baseline">
                                <Grid item xs={12} sm={8}>
                                    ...
                                    <div className="headerContent">
                                            ...
                                            {/* <Typography variant="h5" textAlign="left" gutterBottom>Endomarketing</Typography> */}

                                            <Grid container direction="row" spacing={2} justify="flex-end">
                                                <Grid item xs={12} sm={8}>
                                                    <Typography variant="h5" textAlign="left" gutterBottom>Endomarketing</Typography>
                                                </Grid>
                                                <Grid item xs={12} sm={4} alignContent="flex-end" alignItems="flex-end">
